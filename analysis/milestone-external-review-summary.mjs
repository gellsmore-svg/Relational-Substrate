...
const unificationMap = [
  ...
  },
  {
    ...
    currentReading:
      'Shows held-out material ordering and exact composition accounting. The measured refractive-index challenge is now explicit and unresolved: a first-pass topology-only proxy fails, and the target-implied slope/framework-Al repair candidate fails fresh anorthite validation.',
  },
];
