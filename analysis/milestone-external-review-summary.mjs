...
This challenge anchors measured SiO2, Na2SiO3, held-out NaAlSi3O8, fresh-validation CaAl2Si2O8, and second-generation held-out KAlSi3O8 refractive-index targets and now includes a first-pass topology-only refractive-index proxy. It also records a target-implied slope/framework-Al repair candidate, but the candidate fails fresh anorthite validation. A second-generation modifier-identity candidate added a divalent-modifier correction, but fresh orthoclase validation misses tolerance. This prevents NBO/T composition accounting, or a target-fitted proxy, from being mistaken for a measured material-property pass.
