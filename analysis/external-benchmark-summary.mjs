...
const benchmarks = [
  ...
  materialRefractiveIndex && {
    ...
    conventionalComparator:
      'source-anchored SiO2, Na2SiO3, held-out NaAlSi3O8, fresh-validation CaAl2Si2O8, and second-generation held-out KAlSi3O8 refractive-index targets checked against current material grammar outputs',
