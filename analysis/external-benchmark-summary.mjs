...
const remainingExternalGates = [
  ...
  'Move EM-09 from imported-constant plane-wave relations toward material-response derivation, boundary propagation, or radiation generation.',
];
