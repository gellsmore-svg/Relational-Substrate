...
const checks = [
  ...
  'analysis/ri-structural-predictor-v1-predeclaration.mjs',
  ...
  'analysis/roughness-sulc-open-access-feasibility-record.mjs',
  'analysis/roughness-psd-scatter-chain-runner.mjs',
